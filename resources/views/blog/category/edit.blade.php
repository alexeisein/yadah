                ...
                <div class="featured-heading">
                    <div class="row-fluid">
                        <div class="span10 offset1">
                            <h4 style="color: #c2a270;">EDIT CATEGORY</h4><hr>

                            @include('errors.list')

                            {{ Form::model($category,['method'=>'PATCH','route' =>['category.update', $category->id],'autocomplete' => 'off']) }}

                                @include('partials.blogcategory.form', ['subBtn' => 'UPDATE THIS CATEGORY'])
